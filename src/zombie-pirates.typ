...
#show: book.with(title: "Warhammer Armies Revamped — Zombie Pirates 1.0")
...
#colophon((
  [
    *Warhammer Armies Revamped: Zombie Pirates*, version 1.0 — an unofficial,
    non-commercial fan edition. It builds on *Warhammer Armies Project: Zombie
    Pirates*, version 3.0, written and freely distributed by Mathias Eliasson.
  ],
  [
